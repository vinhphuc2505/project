    ...
    public class TaiKhoanController : BaseController
    {
        ...
        public ActionResult XoaTK(string tendn)
        {
            /*using(var data = new DataClasses1DataContext())
            {
            	...
            	data.TaiKhoans.Single(n => n.TenDN == tendn);
            	data.TaiKhoans.First(n => n.TenDN == tendn);
            	data.TaiKhoans.FirstOrDefault(n => n.TenDN == tendn);
            	if (tk == null)
            	{
            ...
            TaiKhoan tk = data.TaiKhoans.FirstOrDefault(n => n.TenDN == tendn);
            /*data.TaiKhoans.Single(n => n.TenDN == tendn);
            data.TaiKhoans.First(n => n.TenDN == tendn);
            data.TaiKhoans.FirstOrDefault(n => n.TenDN == tendn);*/
            if (tk == null)
